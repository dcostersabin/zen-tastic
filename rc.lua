...
beautiful.init(string.format("%s/.config/awesome/themes/zen-tastic/theme.lua", os.getenv("HOME")))
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.spawn.with_shell("pgrep dunst || dunst")
end)
...
globalkeys = mytable.join(
    awful.key({ modkey,        }, ";", function () spotify_shell.launch() end, {description = "spotify shell", group = "music"}),
    -- Destroy all notifications
    awful.key({ "Control" }, "space", function()

        awful.spawn.with_shell("dunstctl set-paused toggle")
    ...
    awful.key({ altkey }, "p", function()
        os.execute("copyq toggle")
    end, { description = "take a screenshot", group = "hotkeys" }),

    -- X screen locker
    awful.key({ altkey, "Control" }, "l", function()
        os.execute("betterlockscreen -q --lock blur")
    ...
    end, { description = "open obsidian", group = "tag" }),
    ...
    awful.key({ modkey, "Shift" }, "j", function()
        os.execute("xdotool mousemove_relative --sync 0 20")
    end),
    awful.key({ modkey, "Shift" }, "k", function()
        os.execute("xdotool mousemove_relative -- 0 -20")
    end),
    awful.key({ modkey, "Shift" }, "h", function()
        os.execute("xdotool mousemove_relative -- -20 0")
    end),
    awful.key({ modkey, "Shift" }, "l", function()
        os.execute("xdotool mousemove_relative --sync 20 0")
    end),
    awful.key({ modkey, "Shift" }, "Return", function()
        os.execute("xdotool mousemove_relative --sync 0 0 click 1")
    end),

    awful.key({ modkey }, "u", function()
        os.execute("guake-toggle")
    end),
    ...
    awful.key({ altkey }, "Up", function()
        os.execute(string.format("amixer -q set %s 1%%+ unmute", beautiful.volume.channel))
    ...
    awful.key({ modkey }, "p", function()
        os.execute(string.format("rofi -show run -show-icons"))
...
awful.rules.rules = {
    ...
    { rule = { class = "Mattermost" }, properties = { screen = 1, tag = "9" } },
    -- { rule = { class = "Slack" }, properties = { screen = 1, tag = "9" } },
    { rule = { class = "obsidian" }, properties = { screen = 1, tag = "5" } },
}
